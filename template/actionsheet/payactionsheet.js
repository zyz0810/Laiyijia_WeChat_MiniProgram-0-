...
module.exports = {
  ...
  ActionsheetInitData() {
    ...
    let initdata = {
      ...
      useCardMember: false,
      sn: '',
      paytype: 'chinaumsAppletPayPlugin',
      item: [
        {
  ...
  changePayMethod() {
    let itemList = ['微信支付'],
      paytype = ['chinaumsAppletPayPlugin', 'balancePayPlugin', 'cardMemberPayPlugin'],
      that = this
  ...
  payConfirm() {
    ...
    if (this.data.__actionsheet.paytype === 'chinaumsAppletPayPlugin') {
